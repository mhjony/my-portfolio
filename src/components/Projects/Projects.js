                ...
                <ReactBootStrap.Row style={{ textAlign: 'center', margin: '1% 1%' }}>
                    <ReactBootStrap.Col md={4} sm={12}>
                        <ReactBootStrap.Card style={{ width: '80%' }}>
                            <ReactBootStrap.Card.Img variant="top" src="https://github.com/mhjony/my-portfolio/blob/master/public/images/fdf.gif" className="img-responsive" style={{ height: '12vw' }} />
